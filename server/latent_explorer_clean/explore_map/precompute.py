...
def precompute_radial_map(
    ...
    *,
    ...
    _EXPECTED_BYTES = {"flux": 33e9, "krea2": 30e9}
    ...
    # Krea-2 already uses DINOv2 with the right load flags; only patch the FLUX
    # sampler which defaults to gated DINOv3.
    if model not in ("krea2",) and not reused_sampler:

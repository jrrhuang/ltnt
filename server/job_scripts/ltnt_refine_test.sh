...
#SBATCH --time=2:00:00
#SBATCH --job-name=ltntreftest
#SBATCH --output=/home/jerryhua/diffusion/model_inference/logs/ltntreftest_%j.out
set -uo pipefail
...
echo "[reftest] launching isolated server on $(hostname):8002 SANA_LOCAL_PATH=${SANA_LOCAL_PATH:-unset}"
exec /home/jerryhua/conda-envs/KREA_env/bin/python server.py --port 8002
